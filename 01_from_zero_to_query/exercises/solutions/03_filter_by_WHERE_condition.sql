...
-- 03.11 use `BETWEEN ... AND ...` to constrain a quantitative column to a range: how many films are between 80 and 90 minutes long, inclusive?
...
FROM film 
WHERE replacement_cost<16 AND rating='G'
; --73
